  ...
  void _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (response['success'] == true) {
        String rol = response['data']['rol'];

        if (rol == 'ciudadano') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => CiudadanoScreen(user: response['data']),
            ),
          );
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => EmpleadoScreen(user: response['data']),
            ),
          );
        } else {
          // Si es un rol desconocido, puedes enviar al HomeScreen o mostrar un error
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
